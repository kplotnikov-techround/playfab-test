...
// Check username
handlers.IsUsernameAvailable = function (args) {
    var loginResult = server.LoginWithPlayFab (
        {
            TitleId: args.TitleId,
            Username: args.Username,
          	Password: randomString(100, '#aA')
        }
    );
  	if (loginResult.code != 200) {
    	return (loginResult.errorCode == 1001);  	
    }
  	return false;
}

// Check user logged
handlers.IsUserLogged = function (args) {
  	var eventData = args.Data;
	log.debug("Event Raised - Game: " + args.GameId + " Event Type: " + eventData.eventType);
